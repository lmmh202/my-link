  ...
  if (error || !profile) {
    return (
      <div className="relative min-h-screen flex items-center justify-center bg-zinc-950 text-zinc-100 px-4 overflow-hidden">
        ...
        <div className="relative max-w-md w-full bg-zinc-900/60 backdrop-blur-xl border border-zinc-800/80 rounded-3xl p-8 shadow-2xl text-center space-y-6">
          ...
          <div className="pt-2">
            <Link
              href="/"
              className="w-full h-11 rounded-xl bg-zinc-100 text-zinc-950 font-bold hover:bg-white active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between overflow-x-hidden py-12 px-4 select-none">
      ...
      <main className="max-w-md w-full mx-auto flex-grow flex flex-col items-center z-10 space-y-8">
        ...
        <div className="text-center space-y-4 w-full">
          ...
          <div className="space-y-1.5 animate-in fade-in slide-in-from-top-4 duration-500 delay-100 fill-mode-both">
            ...
            <span className="inline-flex px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-xs font-semibold text-emerald-400">
              @{profile.username}
            </span>
          </div>
        ...
        <div className="w-full space-y-3.5 pt-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
          {links.length === 0 ? (
            <div className="bg-zinc-900/30 border border-zinc-800/60 border-dashed rounded-2xl p-10 text-center space-y-2">
      ...
      <footer className="z-10 pt-12 text-center animate-in fade-in duration-1000 delay-500 fill-mode-both">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-900/40 backdrop-blur-sm border border-zinc-900 text-xs font-bold text-zinc-500 hover:text-zinc-300 hover:bg-zinc-900/80 hover:border-zinc-800 transition-all shadow"
        >
          <div className="w-5 h-5 rounded-md bg-gradient-to-tr from-emerald-500 to-teal-400 flex items-center justify-center shadow-md shadow-emerald-500/10">
